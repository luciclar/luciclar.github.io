...
We applied the method to a simulated spatio-temporal dataset exhibiting advective and diffusive behavior on the sphere, as well as to a real case study concerning CO$$_2$$ concentration in the atmosphere at the Earth's surface. The movement of CO$$_2$$ is essentially driven by advection processes (wind currents) and diffusion. Our statistical approach based on physical equations aims to account for this phenomenon.
